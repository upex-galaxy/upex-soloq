...
**AC-3:** Given I view the invoice list, When I look at each row, Then I see: `invoice_number`, `client_name`, `total` (formatted as currency), `issue_date` (human-readable format), and `status` (badge/label).
...
- Display columns: `invoice_number`, `client_name`, `total`, `issue_date`, `status`
...
- **Created:** 2026-01-21T01:09:29.622Z
- **Updated:** 2026-03-24T08:00:23.072Z
- **Reporter:** Ely
