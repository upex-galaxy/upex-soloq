...
[View in Jira](https://upexgalaxy65.atlassian.net/browse/SQ-27)

---

### Froylan Rodriguez - 2/2/2026, 11:36:40 PM

***Shift-Left Testing:*** 

Notas Scenario 1:  Auto-generate invoice number

- La secuencialidad aumenta en +1 siempre? 
- Si el freelance elimina algun invoice, el número secuencial se ve afectado?
- El guardado del invoice es definitivo?, Considero se debe realizar un draft primero y luego mostrarse una previsualización para confirmar el guardado del Invoice. 
- Cual es la extensión del numero? ¿Solo número (1001) o incluye prefijo/sufijo (INV-2026-0001) o permite simbolos. Considero debe tener una estructura similar a 001-002-0002321312. (establecimiento-punto de emisión-secuencial)

Notas Scenario 2:  Custom Invoice Number.

- Este custom invoice number aplica para toda la empresa, por usuario, por sucursal o algún tipo de factura? 
- Se puede cambiar luego personalizar nuevamente el custom invoice number o una vez configurado es estático. 
- El custom invoice number cambia o se versiona si el sistema permite Editar un invoice? 

Notas Scenario 3:  Prevent duplicates.

- Cuál es el mensaje de error que debe mostrar el sistema? Sera un pop-up o un modal? 
- Al detectar una duplicidad, debe impedir la creación? 
- ¿Si 2 usuarios guardan al mismo tiempo, cómo se evita duplicados?

---

***Feature Test Plan:*** 
Feature Test Plan: [https://upexgalaxy65.atlassian.net/browse/SQ-27#icft=SQ-27](https://upexgalaxy65.atlassian.net/browse/SQ-27#icft=SQ-27) - Assign Unique Invoice Number

***Story:**** [SQ-27](https://upexgalaxy65.atlassian.net/browse/SQ-27) ****Epic:**** [https://upexgalaxy65.atlassian.net/browse/SQ-20#icft=SQ-20](https://upexgalaxy65.atlassian.net/browse/SQ-20#icft=SQ-20) - Invoice Creation ****Autor:**** Froylan Rodriguez ****Fecha:*** 2026-02-02
...
- Usar constraint DB `UNIQUE(user*id, invoice*number)` + retry logic
...
### Automation for Jira - 2/11/2026, 10:49:25 PM

🔎 Pull Request created. Task is pending to ANALYZE and REVIEW by the team. Waiting for PR Approval.

---

### Automation for Jira - 2/11/2026, 11:08:36 PM

✅ Pull Request is successfully MERGED. Task is Done.

---

### Ely - 2/11/2026, 11:15:26 PM

PR #46 merged. Implementation complete:

- Auto-generated invoice numbers (INV-YYYY-NNNN format)
- Custom number support with real-time validation
- Configurable prefix from business_profiles
- InvoiceNumberInput component with visual feedback

---


_Synced from Jira by jira-sync_
_Last sync: 2026-03-02T19:53:52.176Z_
