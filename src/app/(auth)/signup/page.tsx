  ...
  if (isSuccess) {
    return (
      <div data-testid="signupPage">
        <Card className="w-full shadow-lg" data-testid="signup_success_card">
          ...
          <CardContent className="space-y-4">
            <Alert className="bg-primary/5 border-primary/20" data-testid="signup_success_alert">
              <AlertDescription>
            ...
            <p className="text-sm text-muted-foreground text-center">
              ...
              <button
                ...
                data-testid="signup_retry_button"
              >
                intenta de nuevo
              </button>
            </p>
          ...
          <CardFooter className="flex justify-center">
            <Button variant="outline" asChild data-testid="signup_back_to_login_button">
  ...
  return (
    <div data-testid="signupPage">
      <Card className="w-full shadow-lg">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4" data-testid="signup_form">
            {error && (
