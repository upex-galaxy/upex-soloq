...
- **Coding prompt (API)**: `.prompts/stage-4-automation/coding/integration-test-coding.md`
- **Coding prompt (E2E)**: `.prompts/stage-4-automation/coding/e2e-test-coding.md`
- **Review prompt (API)**: `.prompts/stage-4-automation/review/integration-test-review.md`
- **Review prompt (E2E)**: `.prompts/stage-4-automation/review/e2e-test-review.md`
...
| Resource | Path |
|----------|------|
| **Stage 4 README** | `.prompts/stage-4-automation/README.md` |
| **Coding: API tests** | `.prompts/stage-4-automation/coding/integration-test-coding.md` |
| **Coding: E2E tests** | `.prompts/stage-4-automation/coding/e2e-test-coding.md` |
| **Review: API tests** | `.prompts/stage-4-automation/review/integration-test-review.md` |
| **Review: E2E tests** | `.prompts/stage-4-automation/review/e2e-test-review.md` |
